...
export default function sitemap(): MetadataRoute.Sitemap {
  const esPages = [
    ...
    { url: `${BASE_URL}/newsletter`, changeFrequency: "weekly" as const, priority: 0.9 },
    { url: `${BASE_URL}/sobre-mi`, changeFrequency: "monthly" as const, priority: 0.7 },
    { url: `${BASE_URL}/contacto`, changeFrequency: "monthly" as const, priority: 0.5 },
  ];
  const enPages = [
  ...
  const esArticles = getArticleSlugs("es").map((slug) => ({ url: `${BASE_URL}/newsletter/${slug}`, changeFrequency: "monthly" as const, priority: 0.8 }));
